...
//1610. Расставь вызовы методов join().
//Вы решили задачу лучше, чем 43% учеников.
//Вам удалось ее решить с 1 попытки.
//Среднее количество попыток для этой задачи 2.0.
//Всего эту задачу решили 38716 учеников.